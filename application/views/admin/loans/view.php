          ...
          <div class="table-responsive">
            <div class="clearfix mb-2">
              <div class="float-left">
                Monto Credito: <?= number_format($loan->credit_amount, 2); ?>
                <br>
                Interes Credito: <?= $loan->interest_amount.'%'; ?>
                <br>
                Nro cuotas: <?= $loan->num_fee; ?>
                <br>
                Monto cuota: <?= number_format($loan->fee_amount, ); ?>
                <br>
                Tipo moneda: <?= ucfirst($loan->short_name); ?>
                <br>
              </div>
              <div class="float-right">
                Fecha Credito: <?= $loan->date; ?>
                <br>
                Forma Pago: <?= ucfirst($loan->payment_m); ?>
                <br>
                ...
                <tbody>
                  ...
                  if ($items) {
                    ...
                    foreach ($items as $item) {
                      ...
                      echo '<td class="text-right">'.number_format($item->fee_amount, 2).'</td>';
